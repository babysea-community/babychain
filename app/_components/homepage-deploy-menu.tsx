...
export function HomepageDeployMenu({
  ...
  return (
    <div className={className} ref={containerRef}>
      ...
      {isOpen ? (
        <div
          className="absolute left-0 top-full z-50 mt-2 w-full border border-border bg-card p-1 shadow-xl"
          id={menuId}
          role="menu"
        >
...
function renderHostIcon(label: string) {
  ...
  switch (hostLabel) {
    ...
    case 'CloudFormation':
      return (
        <InlineCloudFormation className={iconClassName} aria-hidden="true" />
      );
    case 'Cloud Run':
      return <InlineCloudRun className={iconClassName} aria-hidden="true" />;
    case 'Coolify':
    ...
    case 'EC2':
      return <InlineEc2 className={iconClassName} aria-hidden="true" />;
    case 'Fly.io':
