      ...
      {steps.map((step, index) => {
        ...
        return (
          <div className="relative" key={step.key}>
            <Card
              className="relative overflow-hidden border border-border bg-card shadow-none [animation:babychain-step-wait_2.8s_ease-in-out_infinite] motion-reduce:[animation:none]"
              style={{ animationDelay }}
            >
              <span
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,var(--chain-accent),transparent)] [animation:babychain-energy-flow_2.4s_linear_infinite] motion-reduce:[animation:none]"
                style={{ animationDelay }}
              />
              <CardHeader>
                <Badge
            ...
            {index < steps.length - 1 ? (
              ...
              >
                <span
                  className="absolute inset-0 bg-[linear-gradient(180deg,transparent,var(--chain-accent),transparent)] [animation:babychain-energy-flow-y_1.6s_linear_infinite] motion-reduce:[animation:none] lg:bg-[linear-gradient(90deg,transparent,var(--chain-accent),transparent)] lg:[animation:babychain-energy-flow_1.6s_linear_infinite]"
