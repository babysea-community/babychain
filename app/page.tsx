...
const HOST_ICONS = [
  ...
  { Icon: InlineAwsCloudFormation, isActive: false, label: 'CloudFormation' },
  { Icon: InlineGoogleCloudRun, isActive: false, label: 'Cloud Run' },
  ...
  { Icon: InlineAwsEc2, isActive: false, label: 'EC2' },
