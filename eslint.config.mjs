// Flat ESLint config for the BabyChain starter.
//
// Goals:
...
const SERVER_ONLY_PATTERNS = [
  ...
  },
  {
    ...
    message:
      'BabyChain API and chain runtime modules are server-only. Call them from a route handler, server module, script, or test. Type-only imports are allowed.',
    allowTypeImports: true,
  },
  {
    group: [
