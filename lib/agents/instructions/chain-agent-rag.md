...
This is the Amazon Nova "Provide supporting text" RAG pattern (the docs treat a managed Bedrock Knowledge Base as a separate, optional retriever, which BabyChain does not need for run-local planning):
