...
function setAwsS3Env(endpointUrl: string) {
  process.env.BABYCHAIN_STORAGE_PROVIDER = 'aws-s3';
  process.env.AWS_S3_REGION = 'us-east-1';
  process.env.AWS_S3_BUCKET_NAME = 'babychain-media';
...
describe('invalidateRunCdnCache', () => {
  ...
  it('does nothing when storage is not AWS S3', async () => {
    process.env.BABYCHAIN_STORAGE_PROVIDER = 'vercel-blob';
  ...
  it('skips public URLs that point straight at the S3 REST API', async () => {
    setAwsS3Env('https://babychain-media.s3.us-east-1.amazonaws.com');
